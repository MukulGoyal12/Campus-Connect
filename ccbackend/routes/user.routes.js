import { fetchUser, verifyEmail, getAllUsers, getUserById, login, logout, register, uploadImage, relevantUsers, getRelevantUsers } from "../controllers/User.controller.js";
...
export function userRoutes(app){
    ...
    app.get('/api/users/relevant', isLoggedIn, getRelevantUsers);
}